...
Func CreateTroopsSpellsSubTab()
   ...
   Local $x = 0
   Local $y = 8
	   $g_hChkUseQuickTrain = GUICtrlCreateCheckbox(GetTranslated(621, 34, "Quick Train"), $x + 15, $y + 19, -1, 15)
	   GUICtrlSetState(-1, $GUI_UNCHECKED)
	   GUICtrlSetOnEvent(-1, "chkUseQTrain")
	   For $i = 0 To 2												; QuickTrainCombo (check box) - Demen
		   $g_ahChkArmy[$i] = GUICtrlCreateCheckbox("Army " & $i+1, $x + 146 + $i*60, $y + 21, 50, 15)
		   GUICtrlSetState(-1, $GUI_DISABLE)
		   If $i = 0 Then GUICtrlSetState(-1, $GUI_CHECKED)
		   GUICtrlSetOnEvent(-1, "chkQuickTrainCombo")
	   Next															; QuickTrainCombo (check box) - Demen
	   GUICtrlCreateLabel(GetTranslated(621, 41, "Reset"), $x + 370, $y + 22, -1, 15, $SS_LEFT)
	   GUICtrlCreateIcon($g_sLibIconPath, $eIcnResetButton, $x + 401, $y + 17, 24, 24)
