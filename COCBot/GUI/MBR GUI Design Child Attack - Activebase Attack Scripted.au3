...
Func CreateAttackSearchActiveBaseScripted()
   ...
   ;			_GUICtrlSetTip(-1, GetTranslated(607,3, -1))
	...
	;	   $y += 110
		   ...
		   GUICtrlCreateButton(GetTranslated(607, 34, -1), $x + 159, $y + 112, 66, 23)
			   ;GUISetState(@SW_SHOW)
			   GUICtrlSetOnEvent(-1, "AttackNowLB")

		   Local $x = 55, $y = 233

		   GUICtrlCreateLabel(GetTranslated(607, 35, -1), $x - 25, $y - 6, 95, -1)
		   $g_hCmbCSVSpeed[$LB] = GUICtrlCreateCombo("", $x + 71, $y - 10, 54, 23, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
