...
Func CreateAttackSearchDeadBaseScripted()
   ...
   ;			_GUICtrlSetTip(-1, $txtTip)
	...
	;	   $y += 110
		   Local $Group = GUICtrlCreateGroup("", $x, $y + 100, 230, 42)
		   GUICtrlCreateButton(GetTranslated(607, 34, "Attack Now"), $x + 159, $y + 112, 66, 23)
			   ;GUISetState(@SW_SHOW)
			   GUICtrlSetOnEvent(-1, "AttackNowDB")

		   Local $x = 55, $y = 233

		   GUICtrlCreateLabel(GetTranslated(607, 35, "Deployment Speed:"), $x - 25, $y - 6, 95, -1)
		   $g_hCmbCSVSpeed[$DB] = GUICtrlCreateCombo("", $x + 71, $y - 10, 54, 23, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			   GUICtrlSetData(-1, " 0.5 x| 0.7 x| 1.0 x| 1.2 x| 1.5 x| 2.0 x| 3.0 x", " 1.0 x")
