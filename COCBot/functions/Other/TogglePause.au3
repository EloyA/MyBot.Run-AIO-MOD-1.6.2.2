...
Func TogglePauseUpdateState($Source)
	...
	;~	TrayTip($g_sBotTitle, "", 1) ;=> Disable Pause Notify
	;~	TrayTip($g_sBotTitle, "was Paused!", 1, $TIP_ICONEXCLAMATION) ;=> Disable Pause Notify
	...
	;~	TrayTip($g_sBotTitle, "", 1) ;=> Disable Resumed Notify
	;~	TrayTip($g_sBotTitle, "was Resumed.", 1, $TIP_ICONASTERISK) ;=> Disable Resumed Notify
